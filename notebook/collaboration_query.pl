...
last_cell_value(ValueId,CellId,StateId,Val,PrevStateId):
    cell_values(ValueId,CellId,StateId,Val,PrevStateId),
    not last_cell_value_not(PrevStateId).

cell_value_constraint(ValueId1,ValueId2,CellId,Val1,Val2):-
